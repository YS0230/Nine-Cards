...
first revealed (drawn or discarded), deduped by card id in `Table.tsx`; it also plays 吃/聽/胡/死牌
effect clips on eat, new tenpai, win, and dead-card-discarded transitions. Clips are silence-trimmed at decode time
